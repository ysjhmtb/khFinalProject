...
ALTER TABLE MEMBER ADD(STOP_DATE DATE);
...
CREATE SEQUENCE SEQ_BENNER START WITH 1 INCREMENT BY 1 NOCYCLE;
...
COMMENT ON COLUMN MESSAGE.EMAIL IS '메시지_멤버이메일(아이디)';
COMMENT ON COLUMN MESSAGE.M_WRITER IS '보낸사람';
COMMENT ON COLUMN MESSAGE.M_RECIVER IS '받는사람';
